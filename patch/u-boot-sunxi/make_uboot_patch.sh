#!/bin/sh
# make_uboot_patch.sh, save add/changed files patch dir
#    run command "git status" to get the changed files
cd `dirname $0`
TOP_DIR=`pwd`/../
TMP_PATCH_DIR=`pwd`/../patch_tmp/patch/u-boot-sunxi/
...
echo "generated kernel patch to $TOP_DIR/patch/u-boot-sunxi"
