...
struct __disp_video_timing video_timing[] = {
	...
	/* index 16 */
	{ HDMI640_480_60,      25200000,  0,  640,   480,  800,  144, 16, 96, 525, 35,  10,  2, 0,  0,  0 },
	{ HDMI640_480_72,      31200000,  0,  640,   480,  832,  168, 24, 40, 520, 31,   9,  3, 0,  1,  1 },
...
#ifdef CONFIG_SUNXI_DVI_FIX
	if ((get_hdmi_mode() != DVI_MODE) && audio_enable)
#else
	if (audio_enable)
#endif
